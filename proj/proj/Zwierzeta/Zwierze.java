...
abstract public class Zwierze extends Organizm {
    ...
    public Zwierze(int polozenieX, int polozenieY, int sila, int inicjatywa, String znak_gatunku, int wiek, String nazwa, Swiat swiat) {
    ...
    public void Rozmnazanie(Organizm o)
    {
        ...
        int xDziecka, yDziecka, kierunek;
        Random rand = new Random();
        while (true)
        {
        ...
        if (!Objects.equals(o.GetNazwa(), "Czlowiek"))
        {
            swiat.WypiszZdarzenie(o.GetNazwa() + "(" + o.GetPolozenieX() + "," + o.GetPolozenieY() + ") rozmnaza sie z " + nazwa + "(" + polozeniex + "," + polozeniey + ") na pole: " + xDziecka + "," + yDziecka);
            o.PostawDziecko(xDziecka, yDziecka);
        }
    }
}
